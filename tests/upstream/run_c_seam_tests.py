...
--baseline extracts the source checkout HEAD for a negative control.
"""
...
output=Path(os.environ.get('ASAHI_TEST_OUTPUT', str(root)))
cfile=output/f'seam-{tag}.c';exe=output/f'seam-{tag}'
